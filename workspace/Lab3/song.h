...
//amp dbc notes that we added for zelda

#define A6NOTE ((uint16_t)(((FUDGEFACTORNOTE*50000000/2)/2)/1760.000))
#define G6NOTE ((uint16_t)(((FUDGEFACTORNOTE*50000000/2)/2)/1567.982))
...
//zelda song of healing note amp dbc
B5NOTE,
D5NOTE,
G5NOTE,
A5NOTE,
